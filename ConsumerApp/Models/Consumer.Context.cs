...
namespace ConsumerApp.Models
{
    ...
    public partial class consumerEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetMerchantListForPendingRevies_Result> GetMerchantListForPendingRevies(string consumerId)
        {
            var consumerIdParameter = consumerId != null ?
                new ObjectParameter("ConsumerId", consumerId) :
                new ObjectParameter("ConsumerId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetMerchantListForPendingRevies_Result>("GetMerchantListForPendingRevies", consumerIdParameter);
        }
