...
namespace MerchantApp.Models
{
    ...
    public partial class MerchantEntities : DbContext
    {
        ...
        public virtual DbSet<expiryperiodmaster> expiryperiodmasters { get; set; }
        public virtual DbSet<pointscashbackexpiry> pointscashbackexpiries { get; set; }
        ...
        public virtual int InsertReviewQuestions(Nullable<int> merchantId, string question1, string question1Type, string question2, string question2Type, string question3, string question3Type, string question4, string question4Type, string defaultQuestion, string defaultType, string merchantUserId, ObjectParameter iD)
        {
            ...
            var question1TypeParameter = question1Type != null ?
                new ObjectParameter("Question1Type", question1Type) :
                new ObjectParameter("Question1Type", typeof(string));
    
            var question2Parameter = question2 != null ?
                new ObjectParameter("Question2", question2) :
                new ObjectParameter("Question2", typeof(string));
    
            var question2TypeParameter = question2Type != null ?
                new ObjectParameter("Question2Type", question2Type) :
                new ObjectParameter("Question2Type", typeof(string));
    
            var question3Parameter = question3 != null ?
                new ObjectParameter("Question3", question3) :
                new ObjectParameter("Question3", typeof(string));
    
            var question3TypeParameter = question3Type != null ?
                new ObjectParameter("Question3Type", question3Type) :
                new ObjectParameter("Question3Type", typeof(string));
    
            var question4Parameter = question4 != null ?
                new ObjectParameter("Question4", question4) :
                new ObjectParameter("Question4", typeof(string));
    
            var question4TypeParameter = question4Type != null ?
                new ObjectParameter("Question4Type", question4Type) :
                new ObjectParameter("Question4Type", typeof(string));
    
            var defaultQuestionParameter = defaultQuestion != null ?
                new ObjectParameter("DefaultQuestion", defaultQuestion) :
                new ObjectParameter("DefaultQuestion", typeof(string));
    
            var defaultTypeParameter = defaultType != null ?
                new ObjectParameter("DefaultType", defaultType) :
                new ObjectParameter("DefaultType", typeof(string));
    
            var merchantUserIdParameter = merchantUserId != null ?
                new ObjectParameter("MerchantUserId", merchantUserId) :
                new ObjectParameter("MerchantUserId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertReviewQuestions", merchantIdParameter, question1Parameter, question1TypeParameter, question2Parameter, question2TypeParameter, question3Parameter, question3TypeParameter, question4Parameter, question4TypeParameter, defaultQuestionParameter, defaultTypeParameter, merchantUserIdParameter, iD);
        }
