...
namespace MerchantApp.Models
{
    ...
    public partial class merchant_master
    {
        ...
        public merchant_benefits benefits { get; set; }

        public pointscashbackexpiry exp { get; set; }

        public branch_master branch { get; set; }

        public brand_master brand { get; set; }

        public staff_master staff { get; set; }
        ...
        public redeemoption redeemoptions { get; set; }
        public Nullable<int> JoiningBonus { get; set; }
        public cashbackdetail cashbackdetails { get; set; }
    }
}
